...
<style type="text/css">
    ...
    .new_topbg{height: 220px; background:url({{asset('images/new_stop_index.jpg')}}) no-repeat center 100%;}
    .new_topbg h1{color: #fff; font-size: 24px; margin-top: 65px;}
    .new_index_logo{padding:20px 0 0 20px;}

    .new_index_icon{background: url({{asset('images/new_stop_index_icon.svg')}}) no-repeat;background-size: 440px; }
...
<div class="new_topbg locate">
    <div class="new_index_logo">
        <img src="{{asset('images/lodlogo2.png')}}" width="190">
    </div>
    <h1 class="text-center">{{$n_location_name}}</h1>
   <!--  <div class="row" style="margin-top:15px;">
        <a href="{{url('biz/login_out')}}" class="btn btn-warning btn-block btn-lg">退出登录</a>
    </div> -->
    <a  href="{{url('biz/login_out')}}" class="pull-right absolute_fix tuichu"><span class="tuichuico"></span></a>
</div>


<div class="text-center locate">
    <img src="{{asset('images/new_stop_index_line.svg')}}" width="100%" class="absolute_fix new_stop_index_line" >

    <div class="col-xs-6 index_btn bottom_border">
        <a href="{{url('purchase/home')}}">
            <span class="new_index_icon Purchase"></span>
            批发采购
        </a>
    </div>
    <div class="col-xs-6 index_btn left_border bottom_border">
        <a href="{{url('store/view',array('id'=>$n_location_id))}}">
            <span class="new_index_icon e_shop"></span>
            微商城
        </a>
    </div>
    <div class="col-xs-6 index_btn bottom_border">
        <a href="{{url('biz/shop_count')}}">
            <span class="new_index_icon admini"></span>
            门店管理
        </a>
    </div>
    <div class="col-xs-6 index_btn left_border bottom_border">
        <a href="{{url('biz/entrance_more',array('id'=>$n_location_id))}}">

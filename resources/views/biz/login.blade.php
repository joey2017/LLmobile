...
.bossbg{position: relative; width: 100%; min-height: 100%; background: url({{asset('images/bossbg.jpg')}}) no-repeat 0 0 ; background-size: 100%;}
...
.dlbox span{ width: 27px; height: 30px; display:inline-block; background-image: url({{asset('images/dlico.svg')}}); background-repeat: no-repeat; background-size: 27px;}
...
$(function(){
    $("#btn_submit").click(function(){
        ...
        $.post("{{url('biz/ajax_login')}}", parme, function(data) {
            if (data.status) {

...
<title>{{ $title or '诚车堂-全心全意为车主服务' }}</title>
...
@endif
<link rel="stylesheet" type="text/css" href="{{asset('css/css.css?v=20150617')}}">
<script type="text/javascript" src="{{asset('js/jquery.js')}}"></script>
<script type="text/javascript" src="{{asset('js/bootstrap.min.js')}}"></script>
<script type="text/javascript" src="{{asset('js/wap.lazy.min.js')}}"></script>
<script type="text/javascript" src="{{asset('js/jquery.cookie.js')}}"></script> 
<script type="text/javascript" src="{{asset('js/wap_v4_common.js')}}"></script>
